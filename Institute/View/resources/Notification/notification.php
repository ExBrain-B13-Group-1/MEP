...
<body class="bg-gray-300 dark:bg-gray-800">
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <div class="grid grid-cols-3 gap-8 mx-14">
                                <ion-icon name="sunny-outline"
                                    class="w-6 h-6 cursor-pointer dark:text-white modechanges"></ion-icon>
                                <svg class="w-6 h-6 cursor-pointer dark:text-white" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 512 512">
                    ...
                    <div class="flex items-center bg-slate-200 dark:bg-gray-700 rounded-lg cursor-pointer"
                        ...
                        <div class="flex items-center mx-3">
                            <div>
                                <button type="button"
                                    ...
                                    <img class="w-14 h-14 rounded-full select-none"
                            ...
                            <div class="ml-3 pt-2 dark:text-white">
                                ...
                                <p
                                    class="text-sm leading-none text-slate-500 select-none dark:text-white dark:text-opacity-50">
                                    Admin</p>
                                <div class="flex pt-1">
                                    <svg class="w-4 h-4 mt-0.5 mr-0.5" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 14 14">
                                        <g fill="none" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round">
                                            <path d="M7 13.5a6.5 6.5 0 1 0 0-13a6.5 6.5 0 0 0 0 13" />
                                            <path
                                                d="M8.702 5.222a1.332 1.332 0 0 0-1.258-.889H6.412a1.19 1.19 0 0 0-.254 2.353l1.571.344a1.334 1.334 0 0 1-.285 2.637h-.888a1.334 1.334 0 0 1-1.258-.89M7 4.333V3m0 8V9.666" />
                                        </g>
                                    </svg>
                            ...
                            <div id="dropdown-user"
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li>
                                        <a href="#"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Guide</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                    ...
                                    <li>
                                        <a href="#"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Help
                                            Center</a>
                                    </li>
                                </ul>
                                <div class="py-2">
    ...
    <aside id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform-translate-x-full bg-white border-r border-gray-200 sm:translate-x-0  dark:border-gray-700 duration-300"
        aria-label="Sidebar">
            ...
            <ul class="space-y-2 font-medium">
                    ...
                    <a href="#"
                        ...
                        <svg class="w-5 h-5  text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            ...
                            <path fill="currentColor"
                                d="M22.5 12c0-5.799-4.701-10.5-10.5-10.5c-1.798 0-3.493.453-4.975 1.251A10.55 10.55 0 0 0 3.5 5.834V2.5h-2v7h7v-2H4.787a8.55 8.55 0 0 1 3.187-2.988A8.46 8.46 0 0 1 12 3.5a8.5 8.5 0 1 1-8.454 9.396l-.104-.995l-1.989.209l.104.994C2.11 18.384 6.573 22.5 12 22.5c5.799 0 10.5-4.701 10.5-10.5M11 6v6.414l3.5 3.5l1.414-1.414L13 11.586V6z" />
                        </svg>
                ...
                <li>
                    ...
                    <ul id="dropdown-class" class="hidden py-2 space-y-2">
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Class
                                Lists</a>
                        </li>
                        <li>
                            <a href="#"
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        aria-controls="dropdown-example" data-collapse-toggle="dropdown-instructor">
                        <svg class="w-5 h-5  text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                    ...
                    <ul id="dropdown-instructor" class="hidden py-2 space-y-2">
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Instructor
                                List</a>
                        </li>
                        <li>
                            <a href="#"
    ...
    <div class="block pt-20 px-5 ml-64 bg-gray-300 dark:bg-gray-800">
        <div class="h-[80vh] grid grid-cols-8 gap-7 mt-10 ">
                        ...
                        <div class="w-full bg-white dark:bg-gray-700 dark:text-white p-4 text-sm cursor-pointer border-b border-gray-300 dark:border-gray-500">
                            <!-- Search Function -->
                                <div class="relative mb-4">
                                    <input type="text"
                                        class="border border-[#1330c2] dark:border-gray-600 dark:text-gray-100 dark:bg-gray-700 px-4 py-3 rounded flex items-center w-full pl-10 pr-4 text-sm outline-none"
                                        placeholder="Search">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em"
                                        class="absolute top-1/2 left-3 transform -translate-y-1/2 text-[#1330c2] dark:text-gray-400"
                                        viewBox="0 0 24 24">    
                            ...
                            <div class="border border-[#1330c2] dark:border-gray-600 px-2 py-1 rounded flex items-center w-full">
                                <div class="tabs w-full flex justify-between">
                                    <button
                                        class="tab-button bg-[#4460EF] text-white dark:text-white px-4 py-3 rounded w-2/6 mr-2">All</button>
            ...
            <div class="block bg-white col-span-5 rounded-lg py-2 dark:bg-gray-600 duration-500">
                ...
                <div>
                    <div class="py-4 px-6 flex justify-between items-center border-b">
                        ...
                        <div class="flex items-center" id="chat-header">
                            <img src="../../../storages/profile1.svg" id="chat-photo" alt="profile1"
                ...
                <!-- Chat Messages -->
                <div class="h-[62vh] dark:bg-gray-700 bg-[#ECEFFF]  overflow-y-auto ">
                    <div id="chat-container" class="flex-1 p-4 bg-[#ECEFFF] dark:bg-gray-700">
                    ...
                    <div id="chat-input-container" class="p-4 border-t">
                        <div class="flex items-center">
                            <input type="text" id="chat-input"
                                class="w-full border dark:text-white border-gray-300 dark:border-gray-600 bg-gray-200 dark:bg-gray-700 p-2 rounded-md focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Message">
                ...
                <div id="mail-container" class="flex-1 overflow-y-auto p-4 bg-[#ECEFFF] dark:bg-gray-700 dark:text-white" style="display: none;">
                        ...
                        <div class="grid grid-cols-2 p-4 gap-4">
                            <div>
                                <input type="text" id="mail-subject-input"
                                    class="w-full border border-gray-300 bg-gray-100 dark:bg-gray-600 dark:border-gray-700 dark:text-white dark:placeholder:text-white/70  p-2 text-sm rounded-md outline-none mb-4"
                                    placeholder="Subject">
                                <input type="text" id="mail-to-input"
                                    class="w-full border border-gray-300 bg-gray-100 dark:bg-gray-600 dark:border-gray-700 dark:text-white dark:placeholder:text-white/70 p-2 text-sm rounded-md outline-none mb-4"
                                    placeholder="To">
                                <!-- // Send Button -->
                                <div class="w-full">
                            ...
                            <textarea id="mail-body-input"
                                class="w-full border border-gray-300 bg-gray-100 dark:bg-gray-600 dark:border-gray-700 dark:text-white dark:placeholder:text-white/70  p-2 text-sm rounded-md outline-none"
