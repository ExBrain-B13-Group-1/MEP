...
<body class="bg-gray-300 dark:bg-gray-800">
    ...
    <div class="block pt-20 px-5 ml-64 bg-gray-300 dark:bg-gray-800">
        <div class="h-screen grid grid-cols-8 gap-7 mt-10 ">

            <!-- Left Side Common Notification Display -->
            <div class="bg-white col-span-3 rounded-lg px-4 py-2 dark:bg-gray-600 duration-500">
            ...
            <div class="block bg-white col-span-5 rounded-lg px-4 py-2 dark:bg-gray-600 duration-500">
