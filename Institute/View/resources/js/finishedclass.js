let finishedClassListURL = `http://localhost/MEP/Institute/Controller/FinishedClassListController.php`;
let serachByTitleURL = `http://localhost/MEP/Institute/Controller/SearchFinishedClassByTitleController.php`;
...
$(document).ready(function () {
    ...
    let dynurl = finishedClassListURL;
    let rowsPerPage = 10;
    let jsonData = [];
    let currentPage = 1;
            ...
            const row = `
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 underline text-blue-700 cursor-pointer">
                        <a href="finishedclassdetails.php?classid=${rowData.id}">View</a>
                    </td>
                </tr>`;
