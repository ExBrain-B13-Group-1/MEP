...
<head>
    ...
    <title>Enrolled Class View</title>
    <!-- sweetalert -->
...
<body class="bg-gray-300 dark:bg-gray-800">
                        ...
                        <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                <li class="inline-flex items-center">
                                    <a href="./../Student/studentlist.php" class="inline-flex items-center text-base font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span class="ms-1 text-base font-medium md:ms-2 current-pages">Enrolled Students</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
    ...
    <div class="block pt-20 px-5 ml-64 bg-gray-300 dark:bg-gray-800 classlists">
        <div class="h-[83vh] grid grid-cols-8 gap-4 mt-10">
            <div id="list-table" class="bg-white col-span-8 rounded-lg px-4 py-2 dark:bg-gray-600 duration-300">
                <div class="flex justify-between items-center col-span-8">
                ...
                <div class="relative overflow-x-auto shadow-md dark:shadow-none sm:rounded-lg mt-2">
                    <!-- ClassList Table -->
    ...
    <!-- customjs -->
    <script src="./../js/enrolledclassdetailsview.js" type="text/javascript"></script>
</body>
