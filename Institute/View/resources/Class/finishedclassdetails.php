...
<body class="bg-gray-300 dark:bg-gray-800">
    ...
    <div class="block pt-20 px-5 ml-64 bg-gray-300 dark:bg-gray-800 classlists">
        <div class="h-[83vh] grid grid-cols-8 gap-4 mt-10">
            <div id="list-table" class="bg-white col-span-8 rounded-lg px-4 py-2 dark:bg-gray-600 duration-300">
                <div class="dark:text-white mt-5">
                    <h3 id="class-title" class="font-bold">Front-End Development Course</h3>
                    <p class="opacity-60">Class ID - <span id="class-id"></span></p>
                </div>
                ...
                <div class="relative overflow-x-auto shadow-md dark:shadow-none sm:rounded-lg ">
                    ...
                    <div class="relative flex justify-center">
                        ...
                        <div class="absolute right-0 top-6">
                            <button id="update-certification" type="button" class="relative text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-14 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Update</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- student detail card -->
            <div id="card-container" class="hidden bg-white col-span-2 rounded-lg px-10 pt-10 dark:bg-gray-600 duration-300 mr-5 relative">
