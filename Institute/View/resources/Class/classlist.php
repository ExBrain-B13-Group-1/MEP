            ...
            <div class="flex items-center justify-between">
                <div class="ml-64 relative top-3 pl-3">
                    <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500  dark:border-gray-700 dark:text-gray-400">
                        <li class="me-2 h-10">
                            <a href="#" class="inline-block p-4 rounded-t-lg hover:dark:bg-gray-600 changes actives">Class Lists</a>
                        </li>
                        <li class="me-2 h-10">  
                            <a href="#" class="inline-block p-4 rounded-t-lg hover:dark:bg-gray-600 changes">Finished Classes</a>
                        </li>
                    </ul>
                </div>
