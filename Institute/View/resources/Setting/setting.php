...
<body class="bg-gray-300 dark:bg-gray-800">
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="ml-64 relative top-1 pl-3">
                    <ul class="flex flex-wrap text-xl font-medium text-center text-gray-500  dark:border-gray-700 dark:text-gray-400">
                        <li class="me-2 h-10">
                            <a href="#" class="inline-block p-4 rounded-t-lg hover:dark:bg-gray-600 changes actives">General</a>
                        </li>
                        <li class="me-2 h-10">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex items-center bg-slate-200 dark:bg-gray-700 rounded-lg cursor-pointer mr-1" data-dropdown-toggle="dropdown-user">
    ...
    <!-- Data Area Setting-->
    <div class="block pt-20 pb-6 px-6 ml-64  bg-gray-300 dark:bg-gray-800 dashoverviews">
        <div class="grid grid-cols-10 gap-4">
            ...
            <!-- Account & Security -->
            <div class="hidden bg-white col-span-8 col-start-2 rounded-lg px-4 py-2 mt-16 dark:bg-gray-600 duration-500 accsecuritys">

                <div class="grid grid-cols-3 gap-20 px-28 py-20">
                    <div class="col-span-1">
                        <h1 class="text-3xl mb-6 dark:text-white">Change Password</h1>
                        <div class="mb-10 ">
                            <label for="cur-password" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white opacity-65">Current Password</label>
                            <div class="relative">
                                <input type="password" id="cur-password" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••" required />
                                <ion-icon id="toggle-password-cur" name="eye-off-outline" class="dark:text-white absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer"></ion-icon>
                            </div>
                        </div>
                        <div class="mb-10 ">
                            <label for="new-password" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white opacity-65">New Password</label>
                            <div class="relative">
                                <input type="password" id="new-password" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••" required />
                                <ion-icon id="toggle-password-new" name="eye-off-outline" class="dark:text-white absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer"></ion-icon>
                            </div>
                        </div>
                        <div class="mb-10 ">
                            <label for="confirm-password" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white opacity-65">Confirm Password</label>
                            <div class="relative">
                                <input type="password" id="confirm-password" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••" required />
                                <ion-icon id="toggle-password-confirm" name="eye-off-outline" class="dark:text-white absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer"></ion-icon>
                            </div>
                        </div>
                        <div class="mt-14">
                            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xl px-10 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Save</button>
                        </div>
                    </div>

                    <div class="col-span-2">
                        <h1 class="text-3xl mb-6 dark:text-white">Security</h1>
                        <div class="grid grid-col-8 gap-5 bg-gray-200 dark:bg-gray-700 rounded-xl px-5 py-10">
                            <div class="col-span-1">
                                <svg class="w-10 h-10 text-blue-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <g fill="none">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16 8V7a4 4 0 0 0-4-4v0a4 4 0 0 0-4 4v1" />
                                        <path fill="currentColor" fill-rule="evenodd" d="M3.879 7.879C3 8.757 3 10.172 3 13v1c0 3.771 0 5.657 1.172 6.828C5.343 22 7.229 22 11 22h2c3.771 0 5.657 0 6.828-1.172C21 19.657 21 17.771 21 14v-1c0-2.828 0-4.243-.879-5.121C19.243 7 17.828 7 15 7H9c-2.828 0-4.243 0-5.121.879M12 15a1 1 0 1 0 0-2a1 1 0 0 0 0 2m3-1a3.001 3.001 0 0 1-2 2.83V19h-2v-2.17A3.001 3.001 0 1 1 15 14" clip-rule="evenodd" />
                                    </g>
                                </svg>
                            </div>
                            <div class="col-span-6 col-start-2">
                                <h1 class="text-xl font-bold mb-3 dark:text-white opacity-90">Two Factory Authentication</h1>
                                <p class="text-base dark:text-white opacity-70">Two-factor authentication adds an additional layer of security to your accout by requiring more than just a password to sign in.</p>
                            </div>
                            <div class="col-span-1 col-start-8 pr-2">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" value="" class="sr-only peer">
                                    <div class="relative w-11 h-6 bg-gray-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-400 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                </label>
                            </div>
                        </div>

                        <h1 class="text-3xl mb-6 dark:text-white mt-10">Recovery Options</h1>
                        <div class="grid grid-col-8 gap-5 bg-gray-200 dark:bg-gray-700 rounded-xl px-5 py-10">
                            <div class="col-span-1">
                                <svg class="w-10 h-10 text-blue-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14">
                                    <path fill="currentColor" fill-rule="evenodd" d="M10.293 1.293a1 1 0 0 1 1.414 0l2 2a1 1 0 0 1-1.414 1.414L11 3.414L9.914 4.5l1.293 1.293a1 1 0 0 1-1.414 1.414L8.5 5.914L7.446 6.968a4 4 0 1 1-1.414-1.414l1.757-1.757l.004-.004l.004-.004zM2 9a2 2 0 1 1 4 0a2 2 0 0 1-4 0" clip-rule="evenodd" />
                                </svg>
                            </div>
                            <div class="col-span-6 col-start-2">
                                <h1 class="text-xl font-bold mb-3 dark:text-white opacity-90">Recovery Options</h1>
                                <p class="text-base dark:text-white opacity-70">Recovery codes can be used to access your account in the event you lose access to your device and connot receive two-factor authentication codes.</p>
                            </div>
                            <div class="col-span-1 col-start-8">
                                <button type="button" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-base px-5 py-2.5 me-2 mb-2 dark:bg-gray-600 dark:text-white dark:border-gray-600 dark:hover:bg-gray-800 dark:hover:border-gray-600 dark:focus:ring-gray-700">View</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="hidden bg-white col-span-8 col-start-2 rounded-lg px-24 py-16 mt-16 dark:bg-gray-600 duration-500 sociallinks">
                ...
                <div class="grid grid-cols-2 gap-x-20">
                    <div class="mb-6 mt-8">
                        ...
                        <input type="text" id="facebook-link" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="mb-6 mt-8">
                        <label for="telegram-link" class="block mb-2 text-xl text-gray-900 dark:text-white opacity-70">Telegram Link</label>
                        <input type="text" id="telegram-link" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="mb-6 mt-8">
                        <label for="instagram-link" class="block mb-2 text-xl text-gray-900 dark:text-white opacity-70">Instragram Link</label>
                        <input type="text" id="instagram-link" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="mb-6 mt-8">
                        <label for="x-link" class="block mb-2 text-xl text-gray-900 dark:text-white opacity-70">X Link</label>
                        <input type="text" id="x-link" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>
                <div class="flex justify-end mt-10">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xl px-12 py-4 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Update</button>
                </div>
            </div>
