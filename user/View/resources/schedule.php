...
<body class="bg-bgColor">
  ...
  <nav class="bg-white  fixed w-[95%] z-20 top-0 right-0 left-0 m-auto my-2 border-b border-gray-200 rounded-xl  ">
    <div class="max-w-screen-xl flex  items-center justify-between mx-auto px-4 relative">
      ...
      <button onclick="menuForMobile()" data-collapse-toggle="navbar-default" type="button" class="inline-flex  text-primaryColor hover:text-slate-800 flex-col  items-center  w-10 mx-3 h-full justify-center text-sm rounded-lg md:hidden  " aria-controls="navbar-default" aria-expanded="false">
      ...
      <div id="menuList" isOpen="false" class="hidden md:flex absolute md:static top-16 right-0 left-0 mx-24 md:mx-auto  md:items-center md:justify-center bg-gray-200 rounded-xl" id="navbar-default">
        <ul class="flex  flex-col md:flex-row   justify-between items-center  font-medium  md:space-x-10 p-3 md:p-0">
          ...
          <li>
            <a href="./schedule.php" id="userSchedule" aria-active="true" class="block w-full md:w-auto text-center py-2 px-6 aria-[active=true]:bg-primaryColor aria-[active=true]:text-white text-black rounded-xl hover:text-primaryColor">Schedule</a>
          </li>
          <li>
  ...
  <div class="m-auto h-full gap-2 grid grid-cols-3 mt-16 w-[95%]">
    <div class="col-span-2 ">
      <div class="flex justify-between items-center bg-primaryColor w-80 text-white py-2 px-1 rounded-md">
        ...
        <ion-icon name="chevron-forward-circle-outline" class="text-4xl"></ion-icon>
      </div>

      <div class=" w-full h-[80vh] overflow-auto no-scrollbar relative mt-3 ">
        <table class="w-full ">
          <thead class="sticky top-0  z-30 mb-2">
            <tr>
              <td class="w-14 pb-8 ">
                <div class="w-full h-20 bg-bgColor"></div>
              </td>
              <td class="w-20 text-center text-blue-700 bg-bgColor border-b border-gray-300">
                <p class="font-bold text-6xl">6</p>
                <p class="text-xl font-semibold">Sat</p>
                <div class="text-center flex flex-col justify-center items-center">
                  <div class="w-1 h-4 rounded-full bg-white"></div>
                  <div class="w-1 h-1 bg-red-600 mt-1 rounded-full"></div>
                </div>
              </td>
              <td class="w-20 text-center text-blue-700/20 bg-bgColor border-b border-gray-300">
                <p class="font-bold text-6xl">7</p>
                <p class="text-xl font-semibold">Sun</p>
                <div class="text-center flex flex-col justify-center items-center">
                  <div class="w-1 h-5 rounded-full bg-white"></div>
                  <div class="hidden w-1 h-1 bg-red-600 mt-1 rounded-full"></div>
                </div>
              </td>
              <td class="w-20 text-center text-blue-700/20 bg-bgColor border-b border-gray-300">
                <p class="font-bold text-6xl">8</p>
                <p class="text-xl font-semibold">Mon</p>
                <div class="text-center flex flex-col justify-center items-center">
                  <div class="w-1 h-5 rounded-full bg-white"></div>
                  <div class="hidden w-1 h-1 bg-red-600 mt-1 rounded-full"></div>
                </div>
              ...
              <td class="w-20 text-center text-blue-700/20 bg-bgColor border-b border-gray-300">
                <p class="font-bold text-6xl">9</p>
                <p class="text-xl font-semibold">Tue</p>
                <div class="text-center flex flex-col justify-center items-center">
                  <div class="w-1 h-5 rounded-full bg-white"></div>
                  <div class="hidden w-1 h-1 bg-red-600 mt-1 rounded-full"></div>
                </div>
              ...
              <td class="w-20 text-center text-blue-700/20 bg-bgColor border-b border-gray-300">
                <p class="font-bold text-6xl">10</p>
                <p class="text-xl font-semibold">Wed</p>
                <div class="text-center flex flex-col justify-center items-center">
                  <div class="w-1 h-5 rounded-full bg-white"></div>
                  <div class="hidden w-1 h-1 bg-red-600 mt-1 rounded-full"></div>
                </div>
              ...
              <td class="w-20 text-center text-blue-700/20 bg-bgColor border-b border-gray-300">
                <p class="font-bold text-6xl">11</p>
                <p class="text-xl font-semibold">Thu</p>
                <div class="text-center flex flex-col justify-center items-center">
                  <div class="w-1 h-5 rounded-full bg-white"></div>
                  <div class="hidden w-1 h-1 bg-red-600 mt-1 rounded-full"></div>
                </div>
              ...
              <td class="w-20 text-center text-blue-700/20 bg-bgColor border-b border-gray-300">
                <p class="font-bold text-6xl">12</p>
                <p class="text-xl font-semibold">Fri</p>
                <div class="text-center flex flex-col justify-center items-center">
                  <div class="w-1 h-5 rounded-full bg-white"></div>
                  <div class="hidden w-1 h-1 bg-red-600 mt-1 rounded-full"></div>
                </div>
          ...
          <tbody class="overflow-y-scroll   h-full ">
            <tr class=" h-20">
        ...
        <p class="text-xs">Front End Course</p>
            ...
            <tr class=" h-20 ">
              ...
              <td class="h-full  bg-[#7382D2]"></td>
              <td class="h-full  bg-[#ECFCFF]"></td>
              <td class="h-full  border-t border-white"></td>
              <td class="h-full  border-t border-white"></td>
              <td class="h-full  bg-[#C4C2FF]"></td>
              <td class="h-full  border-t border-white"></td>
            ...
            <tr class=" h-20 ">
              ...
              <td class="h-full  bg-[#7382D2]"></td>
              <td class="h-full  bg-[#ECFCFF]"></td>
              <td class="h-full  bg-[#D6E6FF]"></td>
              <td class="h-full  border-t border-white"></td>
              <td class="h-full  border-t border-white"></td>
              <td class="h-full  border-t border-white"></td>
              <td class="h-full  bg-[#838383]"></td>
            </tr>
            ...
            <div class="absolute top-[50%] w-full flex justify-center items-center z-20">
              <p class="text-sm w-fit bg-red-500 text-white p-1">11 AM</p>
              <div class="w-[90%] h-1 bg-red-500"></div>
            </div>
          </tbody>
        </table>
      </div>
      ...
      <div class="w-full h-[80vh] overflow-y-scroll no-scrollbar p-3">
        <div class="bg-[#7382D2] rounded-md p-2 text-white my-2">
          <div class="flex justify-between items-center">
            ...
            <div class="bg-gray-400 rounded-full px-3 flex justify-center items-center">
              <div class="w-3 h-3 bg-slate-800  z-10 rounded-full"></div>
              <p class="ml-2 text-slate-800 text-sm">End</p>
            </div>
          </div>
          ...
          <div class="flex justify-between items-center">
            ...
            <div class="bg-white rounded-full p-1">
              <p class="text-slate-800 text-lg font-medium">30 Min Ago</p>
            </div>
        ...
        <div class="bg-[#7382D2] rounded-md p-2 text-white my-2">
          <div class="flex justify-between items-center">
            <h1 class="text-2xl font-medium">Front-end Class</h1>
            <div class="bg-yellow-400 rounded-full px-3 flex justify-center items-center">
              <div class="w-3 h-3 bg-yellow-800  z-10 rounded-full"></div>
              <p class="ml-2 text-yellow-800 text-sm">Now</p>
            </div>
          </div>
          <div class="w-20 h-14  relative mt-3">
            <img src="./img/profile.png" alt="profile" class="absolute top-0 right-0 z-0 drop-shadow-m mt-3d">
        ...
        <div class="bg-[#7382D2] rounded-md p-2 text-white my-2">
          <div class="flex justify-between items-center">
            <h1 class="text-2xl font-medium">Front-end Class</h1>
            <div class="bg-blue-400 rounded-full px-3 flex justify-center items-center">
              <div class="w-3 h-3 bg-blue-800  z-10 rounded-full"></div>
              <p class="ml-2 text-blue-800 text-sm">Upcoming</p>
            </div>
          </div>
          <div class="w-20 h-14  relative mt-3">
            <img src="./img/profile.png" alt="profile" class="absolute top-0 right-0 z-0 drop-shadow-m mt-3d">
