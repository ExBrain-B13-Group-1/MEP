...
<body class="bg-white">
    ...
    <!-- Navigation bar -->
    <nav class="bg-white  fixed w-[95%] z-100 top-0 right-0 left-0 m-auto my-2 border-b border-gray-200 rounded-xl  ">
        <div class="max-w-screen-xl flex  items-center justify-between mx-auto px-4 relative">
            ...
            <button onclick="menuForMobile()" data-collapse-toggle="navbar-default" type="button"
                class="inline-flex  text-primaryColor hover:text-slate-800 flex-col  items-center p-2 w-10 mx-3 h-full justify-center text-sm rounded-lg md:hidden  "
                aria-controls="navbar-default" aria-expanded="false">
                <ion-icon name="chevron-up-outline" class=" text-lg"></ion-icon>
                <p class=" font-bold ">Class</p>
            </button>

            <div id="menuList" isOpen="false"
                class="hidden md:flex absolute md:static top-16 right-0 left-0 mx-24 md:mx-auto  md:items-center md:justify-center bg-gray-200 rounded-xl"
                id="navbar-default">
                <ul
                    class="flex  flex-col md:flex-row   justify-between items-center  font-medium  md:space-x-10 p-3 md:p-0">
                    <li>
                        <a href="./dashboard.php" id="userDashboard"
                            class="block w-full md:w-auto text-center py-2 px-6 aria-[active=true]:bg-primaryColor aria-[active=true]:text-white text-black rounded-xl hover:text-primaryColor">Dashboard</a>
                    </li>
                    <li>
                        <a href="./class.php" id="userClass" aria-active="true"
                            class="block w-full md:w-auto text-center py-2 px-6 aria-[active=true]:bg-primaryColor aria-[active=true]:text-white text-black rounded-xl hover:text-primaryColor">Class</a>
                    </li>
                    <li>
                        <a href="./schedule.php" id="userSchedule"
                            class="block w-full md:w-auto text-center py-2 px-6 aria-[active=true]:bg-primaryColor aria-[active=true]:text-white text-black rounded-xl hover:text-primaryColor">Schedule</a>
                    </li>
                    <li>
                        <a href="./support.php" id="userSupport"
                            class="block w-full md:w-auto text-center py-2 px-6 aria-[active=true]:bg-primaryColor aria-[active=true]:text-white text-black rounded-xl hover:text-primaryColor">Support</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="flex items-center space-x-2 md:space-x-3 rtl:space-x-reverse my-2">
                ...
                <div class="relative">
                    ...
                    <div id="profileMenu"
                        class="hidden absolute bottom-0 right-0 bg-white w-44 rounded-lg p-3 translate-y-52 translate-x-4">
    ...
    <!--! Start Code Here -->
    <div class="block pt-24 px-4 md:px-32 mb-10 z-20">
        <!-- Hero Section -->
        <div class="container mx-auto">
            ...
            <div class="hidden md:block">
                ...
                <div class="flex mb-4 space-x-4 text-left">
                    <button class="tab-button border-b-2 border-primaryColor text-primaryColor px-4 py-2 z-10"
                        data-tab="most-popular">Most Popular</button>
                    <button
                        class="tab-button px-4 py-2 text-gray-500 hover:text-primaryColor hover:border-primaryColor border-b-2 border-transparent z-10"
                        data-tab="new">New</button>
                    <button
                        class="tab-button px-4 py-2 text-gray-500 hover:text-primaryColor hover:border-primaryColor border-b-2 border-transparent z-10"
                        data-tab="trending">Trending</button>
                </div>
                    ...
                    <div id="controls-carousel" class="w-full " data-carousel="static">
                        ...
                        <div class="relative h-[27rem] carousel-wrapper overflow-hidden">
                            ...
                            <div class="tab-content" id="most-popular">
                                <div class="relative">
                                    <div class="flex justify-center" id="most-popular-slider">
                            ...
                            <div class="tab-content hidden" id="new">
                                <div class="relative">
                                    <div class="flex justify-center " id="new-slider">
                            ...
                            <div class="tab-content hidden" id="trending">
                                <div class="relative">
                                    <div class="flex justify-center " id="trending-slider">
                        ...
                        <div class="flex justify-between items-center relative space-x-10 -top-80">
                            <button type="button"
                                class="z-30 flex items-center justify-center cursor-pointer relative left-[-1.75rem] group focus:outline-none"
                                data-carousel-prev>
                                <span
                                    class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-700">
                                    <svg class="w-4 h-4 text-gray-300 rtl:rotate-180" aria-hidden="true"
                            ...
                            <button type="button"
                                class="z-30 flex items-center justify-center cursor-pointer relative right-[-1.75rem] group focus:outline-none"
                                data-carousel-next>
                                <span
                                    class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-700">
                                    <svg class="w-4 h-4 text-gray-300 rtl:rotate-180" aria-hidden="true"
            ...
            <div class="block md:hidden">
                <div class="accordion-item mt-4">
                    <button
                        class="accordion-button flex justify-between items-center px-4 py-2 rounded w-full text-left"
        ...
        <div class="container mx-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                ...
                <div class="relative w-full md:w-auto">
                    <!-- Search -->
                    <input type="text"
                        class="border border-primaryColor px-10 py-2 rounded flex items-center w-full pl-10 pr-4 text-sm outline-none"
                        placeholder="Search">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em"
                        class="absolute top-1/2 left-3 transform -translate-y-1/2 text-primaryColor"
                        viewBox="0 0 24 24">
                ...
                <div class="flex space-x-4 w-full md:w-auto">
                    ...
                    <div class="relative">
                        <button id="filter-button" data-dropdown-toggle="dropdown"
                            class="border border-primaryColor px-4 py-4 rounded flex items-center w-full md:w-auto pl-10 pr-4 text-sm outline-none">Filter</button>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                            class="absolute top-1/2 left-3 transform -translate-y-1/2" viewBox="0 0 16 16"
                            fill="currentColor">
                            <path
                    ...
                    <!-- Sort By -->
                    <div
                        class="relative inline-block text-left border border-primaryColor rounded pr-2 w-full md:w-auto">
                        <label for="sort" class="block text-xs font-medium text-gray-700 pl-3 mt-1">Sort by</label>
                        <select id="sort"
                            class="block w-full pl-2 pr-9 py-1 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                        ...
                        <div class="rating-options pl-4 mb-4">
                            <div class="flex items-center mt-2">
                                <input id="rating-4-5" type="radio" name="rating" value="4.5"
                                    class="w-4 h-4 text-primaryColor bg-gray-100  rounded-md ">
                        ...
                        <div class="checkbox-list pl-4" id="institutesList">
                            <div class="flex items-center">
                                <input id="" type="checkbox" value=""
                                    class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                <label for="" class="ms-2 text-gray-700">Tech Innovators Academy</label>
                            </div>
                            <div class="flex items-center mt-3">
                                <input id="" type="checkbox" value=""
                                    class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                <label for="" class="ms-2 text-gray-700">Global Code Institute</label>
                            </div>
                            <div class="flex items-center mt-3">
                                <input id="" type="checkbox" value=""
                                    class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                <label for="" class="ms-2 text-gray-700">NextGen Learning Hub</label>
                            </div>
                            <div class="flex items-center mt-3">
                                <input id="" type="checkbox" value=""
                                    class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                <label for="" class="ms-2 text-gray-700">Premier Web Development School</label>
                            </div>
                            <div class="flex items-center mt-3">
                                <input id="" type="checkbox" value=""
                                    class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                <label for="" class="ms-2 text-gray-700">Future Skills University</label>
                            </div>
                            ...
                            <div class="additional-checkboxes hidden">
                                <div class="flex items-center mt-3">
                                    <input id="" type="checkbox" value=""
                                        class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                    <label for="" class="ms-2 text-gray-700">Digital Creators Institute</label>
                                </div>
                                <div class="flex items-center mt-3">
                                    <input id="" type="checkbox" value=""
                                        class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                    <label for="" class="ms-2 text-gray-700">Elite Programming Academy</label>
                                </div>
                                <div class="flex items-center mt-3">
                                    <input id="" type="checkbox" value=""
                                        class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                    <label for="" class="ms-2 text-gray-700">Innovative Minds Institute</label>
                                </div>
                                <div class="flex items-center mt-3">
                                    <input id="" type="checkbox" value=""
                                        class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                    <label for="" class="ms-2 text-gray-700">ProDev Training Center</label>
                                </div>
                                <div class="flex items-center mt-3">
                                    <input id="" type="checkbox" value=""
                                        class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                    <label for="" class="ms-2 text-gray-700">Modern Tech School</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="checkbox-list pl-4" id="classesList">
                            <div class="flex items-center">
                                <input id="" type="checkbox" value="" checked
                                    class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                <label for="" class="ms-2 text-gray-700">Introduction to Web Development</label>
                            </div>
                            <div class="flex items-center mt-3">
                                <input id="" type="checkbox" value=""
                                    class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                <label for="" class="ms-2 text-gray-700">Mastering HTML & CSS</label>
                            </div>
                            <div class="flex items-center mt-3">
                                <input id="" type="checkbox" value=""
                                    class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                <label for="" class="ms-2 text-gray-700">Javascript Essentials</label>
                            </div>
                            <div class="flex items-center mt-3">
                                <input id="" type="checkbox" value=""
                                    class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                <label for="" class="ms-2 text-gray-700">Responsive Web Design</label>
                            </div>
                            <div class="flex items-center mt-3">
                                <input id="" type="checkbox" value=""
                                    class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                <label for="" class="ms-2 text-gray-700">Building Interactive Website with React</label>
                            </div>
                            <!-- Additional hidden checkboxes -->
                            <div class="additional-checkboxes hidden">
                                <div class="flex items-center mt-3">
                                    <input id="" type="checkbox" value=""
                                        class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                    <label for="" class="ms-2 text-gray-700">Backend Development with Node Js</label>
                                </div>
                                <div class="flex items-center mt-3">
                                    <input id="" type="checkbox" value=""
                                        class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                    <label for="" class="ms-2 text-gray-700">Advanced CSS Techniques</label>
                                </div>
                                <div class="flex items-center mt-3">
                                    <input id="" type="checkbox" value=""
                                        class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                    <label for="" class="ms-2 text-gray-700">Full-stack Web Development Bootcamp</label>
                                </div>
                                <div class="flex items-center mt-3">
                                    <input id="" type="checkbox" value=""
                                        class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                    <label for="" class="ms-2 text-gray-700">Web Security Fundamentals</label>
                                </div>
                                <div class="flex items-center mt-3">
                                    <input id="" type="checkbox" value=""
                                        class="w-4 h-4 text-primaryColor bg-gray-100 border-gray-300 rounded-md focus:ring-primaryColor focus:ring-1">
                                    <label for="" class="ms-2 text-gray-700">DevOps for Web Development</label>
                                </div>
                            </div>
                        </div>
