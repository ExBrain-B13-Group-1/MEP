                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center ">
                                    <div class="flex flex-col justify-center md:w-60 w-40">
                                        ...
                                        <div class="flex justify-center items-center">
                                            <p class="text-center inline-block md:text-xl text-sm md:my-1 my-0.5 text-blue-800 mr-3"><?= number_format($userPrices[0]['amount'], 0, '', ','); ?> MMK</p> <small>Lifetime</small>
                                        </div>
                                        <div class="flex justify-center">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center ">
                                    <div class="flex flex-col justify-center md:w-60 w-40">
                                        ...
                                        <div class="flex justify-center items-center">
                                            <p class="text-center inline-block md:text-xl text-sm md:my-1 my-0.5 text-blue-800 mr-3"><?= number_format($institutePrices[2]['amount'], 0, '', ','); ?> MMK</p> <small>MMK/month</small>
                                        </div>
                                        <div class="flex justify-center">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center">
                                    <div class="flex flex-col justify-center md:w-60 w-40">
                                        ...
                                        <div class="flex justify-center items-center">
                                            <p class="text-center inline-block md:text-xl text-sm md:my-1 my-0.5 text-blue-800 mr-3"><?= number_format($institutePrices[3]['amount'], 0, '', ','); ?> MMK</p> <small>MMK/year</small>
                                        </div>
                                        <div class="flex justify-center">
                                            <button class="md:text-base text-sm bg-transparent hover:bg-indigo-800 duration-100 border text-indigo-800 hover:text-gray-50 border-indigo-800 md:w-40 w-full px-5 py-2 rounded-3xl">Contact Sales</button>
                                        </div>
