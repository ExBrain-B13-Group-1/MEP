...
<body class="relative">
        ...
        <nav class="bg-white fixed w-[100%] top-0 left-0 border-b border-gray-200 md:h-18 md:py-1 z-50">
            <div class="md:px-32 flex items-center justify-between mx-auto px-4 relative">
                ...
                <button onclick="menuForMobile()" data-collapse-toggle="menuList" type="button" class="inline-flex text-primaryColor hover:text-slate-800 flex-col items-center p-2 w-10 mx-3 h-full justify-center text-sm rounded-lg md:hidden" aria-controls="navbar-default" aria-expanded="false">
                    <p class="font-bold text-blue-500">Privacy</p>
    ...
    <!-- Privacy Policy -->
    <div>
        <div class="max-w-5xl mx-auto p-4 md:p-8 bg-white shadow-md">
            <h1 class="text-xl md:text-3xl font-bold mb-4">Privacy Policy for Myanmar Education Portal</h1>
            <p class="text-gray-600 mb-2">Effective Date: 01 / 08 / 2024</p>

            <p class="mb-4">This Privacy Policy describes how Myanmar Education Portal ("we", "us", or "our") collects, uses, and discloses your information when you use our Learning Management System website ("Website") and the services we offer ("Services").</p>

            <h2 class="text-lg md:text-2xl font-semibold mb-2">1. Information We Collect</h2>
            <p class="mb-4">We collect several types of information, which can be broadly categorized as follows:</p>
            <ul class="list-disc list-inside mb-4">
                <li><span class="font-semibold">Personal Information:</span> This includes information that can be used to identify an individual, such as name, email address, username, password, and any other data you choose to provide in your profile.</li>
                <li><span class="font-semibold">Usage Data:</span> This information is automatically collected when you use the website and services, such as your browsing activity, course progress, completion data, and IP address.</li>
            </ul>

            <h2 class="text-lg md:text-2xl font-semibold mb-2">2. How We Use Your Information</h2>
            <p class="mb-4">We use the information we collect for the following purposes:</p>
            <ul class="list-disc list-inside mb-4">
                <li>To provide and maintain the website and services</li>
                <li>To personalize your learning experience</li>
                <li>To communicate with you about your account and the services</li>
                <li>To improve the website and services</li>
                <li>To analyze how you use the website and services</li>
                <li>To comply with legal and regulatory obligations</li>
            </ul>

            <h2 class="text-lg md:text-2xl font-semibold mb-2">3. Sharing Your Information</h2>
            <p class="mb-4">We may share your information with third-party vendors who provide services to support the website and services. These vendors are obligated to protect your information and use it only for the purpose we have specified.</p>
            <p class="mb-4">We will not share your personal information with any third parties for marketing purposes without your consent.</p>

            <h2 class="text-lg md:text-2xl font-semibold mb-2">4. Accessing Your Information</h2>
            <p class="mb-4">You have certain choices regarding your information:</p>
            <ul class="list-disc list-inside mb-4">
                <li><span class="font-semibold">Accessing your information:</span> You can access and update your profile information at any time.</li>
                <li><span class="font-semibold">Deleting your information:</span> You can request to delete your account and information.</li>
            </ul>

            <h2 class="text-lg md:text-2xl font-semibold mb-2">5. Data Retention</h2>
            <p class="mb-4">We will retain your information for as long as your account is active or as needed to provide you with the services. We may also retain certain information for legal or regulatory reasons.</p>

            <h2 class="text-lg md:text-2xl font-semibold mb-2">6. Security Measures</h2>
            <p class="mb-4">Our website and services are not directed to children under the age of 13. We do not knowingly collect personal information from children under 13. If you are a parent or guardian and you believe that your child has provided us with personal information, please contact us.</p>

            <h2 class="text-lg md:text-2xl font-semibold mb-2">7. Children's Privacy</h2>
            <p class="mb-4">Our website and services are not directed to children under the age of 13. We do not knowingly collect personal information from children under 13. If you are a parent or guardian and you believe that your child has provided us with personal information, please contact us.</p>

            <h2 class="text-lg md:text-2xl font-semibold mb-2">8. Changes to this Policy</h2>
            <p class="mb-4">We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on the website.</p>

            <h2 class="text-lg md:text-2xl font-semibold mb-2">Contact Us</h2>
            <p class="mb-4">If you have any questions about this Privacy Policy, please contact us at: <a href="mailto:myanmareduportal@org.com" class="text-blue-600 hover:underline">myanmareduportal@org.com</a></p>
            <p class="mb-4">Myanmar Education Portal (MEP)</p>
        </div>
    </div>
