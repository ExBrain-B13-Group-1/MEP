...
<body class="bg-bgColor">
    ...
    <div class="max-w-screen-xl flex items-center justify-between mx-auto px-4 ">
      ...
      <div class="flex  items-center justify-center   bg-gray-200 rounded-xl" id="navbar-sticky">
        <ul class=" flex justify-between items-center  font-medium  space-x-10 ">
          ...
          <li>
            <a href="./user-class-details.php" id="userClass"
          ...
          <li>
            <a href="./support.php" aria-active="true" id="userSupport"
  ...
  <div class="block pt-20 px-10 ml-6 mb-10">
    <div class="h-screen grid grid-cols-4 gap-7 mt-3">
      <div class="col-span-4 rounded-lg px-2 duration-500 no-scrollbar md:overflow-y-auto overflow-y-hidden h-full"
        id="left-side">
          ...
          <div class="flex overflow-hidden h-full">
            <div class="w-full p-4 overflow-y-auto no-scrollbar text-sm">
              ...
              <div class="tabs w-full grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
                <div
                  class="tab-button col-span-1 w-full bg-[#4460EF] text-white px-4 py-6 rounded-lg mr-2 flex flex-col items-center cursor-pointer"
                  data-tab="faq">
                ...
                <div
                  class="tab-button col-span-1 w-full bg-white text-[#4460EF] px-4 py-6 rounded-lg mr-2 flex flex-col items-center cursor-pointer"
                  data-tab="tutorials">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12" viewBox="0 0 24 24">
                    <path fill="currentColor"
                ...
                <div
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12" viewBox="0 0 24 24">
                    <path fill="none" stroke="currentColor" stroke-width="1.5"
                      d="m4 11.5l-.485.121A2 2 0 0 0 2 13.561v1.877a2 2 0 0 0 1.515 1.94l1.74.435A.6.6 0 0 0 6 17.231v-5.463a.6.6 0 0 0-.746-.582zm0 0V11a8 8 0 1 1 16 0v.5m0 0l.485.121A2 2 0 0 1 22 13.561v1.877a2 2 0 0 1-1.515 1.94L20 17.5m0-6l-1.255-.314a.6.6 0 0 0-.745.582v5.463a.6.6 0 0 0 .745.582L20 17.5m-5 3h3a2 2 0 0 0 2-2v-1m-5 3a1.5 1.5 0 0 0-1.5-1.5h-3a1.5 1.5 0 0 0 0 3h3a1.5 1.5 0 0 0 1.5-1.5zm-4 0H6a2 2 0 0 1-2-2v-1" />
                  </svg>
                ...
                <div class="container mx-auto px-4 py-8">
                  ...
                  <div class="bg-white p-6 rounded-lg shadow-lg cursor-pointer">
                    <div class="space-y-4">
                      ...
                      <div>
                        <div
                          class="accordion-button flex justify-between items-center w-full p-4 bg-primaryColor/10 rounded-lg">
              ...
              <div id="guide-content" class="tab-content hidden">
                ...
                <div class="flex justify-center items-center space-x-3">
                  <button
                    class="py-2 px-6 bg-white text-primaryColor font-semibold rounded-md flex justify-center ">View
                    Guide &nbsp;&nbsp; <ion-icon name="eye-outline" class="text-xl"></ion-icon></button>
                  <button
                    class="py-2 px-6 bg-primaryColor text-white font-semibold rounded-md flex justify-center ">Download
              ...
              <!-- Help Section -->
              <div id="help-content"
                class="tab-content hidden max-w-4xl mx-auto mt-10 p-6 bg-white/50 rounded-lg shadow-lg">
                ...
                <form action="" class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">               
                  <div class="col-span-1">
                    ...
                    <div class="mb-7">
                      <input type="text" id="name" placeholder="Name"
                        class="w-full px-4 py-2 rounded-md text-black focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <!-- Comment -->
                    <div>
                  ...
                  <div class="col-span-1">
                    ...
                    <button type="submit" id="send-message"
                      class=" bg-[#4460EF] text-white py-2 px-4 rounded-md flex items-center space-x-4 float-right">
                      Send
                      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" class="inline ml-1"
                        viewBox="0 0 24 24">
