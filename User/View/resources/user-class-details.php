        ...
        <div class=" flex items-center justify-between mx-auto px-4 ">
            ...
            <div class="flex items-center space-x-3 rtl:space-x-reverse my-2">
                ...
                <div class="relative">
                    ...
                    <div id="profileMenu"
                        class="hidden absolute bottom-0 right-0 bg-white w-44 rounded-lg p-3 translate-y-44 translate-x-4">
        ...
        <div class="class-details-main">
            ...
            <div class="main-container">
                ...
                <div class="right-details-container">
                    ...
                    <p class="instructor">Instructor - <a href="" class="instructor-link">Matthew Davis</a></p>
                    ...
                    <div class="deadline-container">
                        <p class="deadline-header">Enrollment Deadline - </p>
        ...
        <div class="enrolled-classes-container">
            ...
            <div class="enrolled-classes-details">
                <div class="enrolled-classes-image-container">
                    ...
                    <div class="enrolled-classes-text">
                        ...
                        <div class="enrolled-classes-details-deadline">
                            <p class="enrollment-deadline">Enrollment Deadline -</p>
                ...
                <div class="enrolled-classes-rating">
                        ...
                        <ion-icon name="star" class="enrolled-star"></ion-icon>
                </div>
                <div class="enrolled-student-count">
                    <ion-icon name="people" class="enrolled-count"></ion-icon>
            ...
            <div class="enrolled-show-more">
                <button class="show-more">Show More <ion-icon name="chevron-down-outline" class="show-more-drop-down-icon"></ion-icon></button>
            </div>
        </div>
    </div>
    <div class="institute-information-section">
        <div class="institute-information-header">
            Institute Information
        </div>
        <div class="institute-information-details">
            <img src="../resources/img/Institute.png" alt="">
            <div class="institute-right-container">
                <div class="institute-name">Global Code Institute</div>
                <div class="institute-location">
                    <img src="../resources/img/location-icon.png" alt="">
                    <div class="institute-location-details">
                        <p class="institute-location-text">No.95, North Dagon, Yangon</p>
                        <a href="" class="institute-location-google-maps">https://maps.app.goo.gl/3GgqbSzo71QkeUMv9</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="institute-information-contacts">
            <div class="institute-information-contacts-email institute-info-rows">
                <ion-icon name="mail-outline"></ion-icon>
                <p class="institute-information-contacts-email-value">globalcodeinstitute@gmail.com</p>
            </div>
            <div class="institute-information-contacts-phone institute-info-rows">
                <ion-icon name="call-outline"></ion-icon>
                <p class="institute-information-contacts-phone-value">(+95) 976XXXXXXXX</p>
            </div>
            <div class="institute-information-contacts-website institute-info-rows">
                <ion-icon name="globe-outline"></ion-icon>
                <a href="" class="institute-information-contacts-website-value">globalcodeinstitute.com</a>
            </div>
        </div>
        <div class="institute-information-description">
            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and 
        </div>
    </div>
    <div class="instructor-information-section">
        <div class="instructor-information-header">
            Instructor
        </div>
        <div class="instructor-information-details">
            <a href="" class="instructor-information-details-header">
                Matthew Davis
            </a>
            <div class="occupation">Software Engineer</div>
            <div class="instructor-information-details-inner-container">
                <img src="../resources/img/instructor.png" alt="">
                <div class="instructor-information-details-inner-container-right-container">
                    <div class="instructor-information-rating instructor-info-rows">
                        <ion-icon name="star" class="instructor-star"></ion-icon>
                        <div class="instructor-rating instructor-inner-info-rows">
                            <div class="instructor-rating-value">4.5</div>
                            Instructor Rating
                        </div>
                    </div>
                    <div class="instructor-information-reviews instructor-info-rows">
                        <ion-icon name="ribbon-outline"></ion-icon>
                        <div class="instructor-review instructor-inner-info-rows">
                            <div class="instructor-review-value">321</div>
                            Reviews
                        </div>
                    </div>
                    <div class="instructor-information-students instructor-info-rows">
                        <ion-icon name="people" class="instructor-student-count-icon"></ion-icon>
                        <div class="instructor-student-count instructor-inner-info-rows">
                            <div class="instructor-student-count-value">1,521</div>
                            Students
                        </div>
                    </div>
                    <div class="instructor-information-classes instructor-info-rows">
                        <ion-icon name="bookmarks-outline"></ion-icon>
                        <div class="instructor-classes instructor-inner-info-rows">
                            <div class="instructor-classes-value">15</div>
                            Classes
                        </div>
                    </div>
                </div>
            </div>
            <div class="instructor-information-biography">
                <div class="instructor-information-biography-header instructor-info-header">Biography</div>
                <div class="instructor-information-biography-description instructor-info-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and </div>
            </div>
            <div class="instructor-information-education">
                <div class="instructor-information-education-header instructor-info-header">Education</div>
                <div class="instructor-information-education-description instructor-info-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and </div>
            </div>
            <div class="instructor-information-experience">
                <div class="instructor-information-experience-header instructor-info-header">Experience</div>
                <div class="instructor-information-experience-description instructor-info-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and </div>
            </div>
        </div>
    </div>
    <footer>
