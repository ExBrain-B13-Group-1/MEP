...
<head>
    ...
    <link rel="stylesheet" href="./css/user-class-search.css">
    ...
    <script src="../resources/js/user-class-search.js"></script>
...
<body>
    ...
    <div class="course-search-header-section">
        <div class="course-search-header-container">
            <div class="course-search-header">Web Development Courses</div>
            <div class="course-search-header-description">Explore courses from experienced,real-world experts</div>
        </div>
    ...
    <div class="tabs-section">
        <div class="most-popular tabs clicked">Most Popular</div>
        <div class="new tabs">New</div>
        <div class="Trending tabs">Trending</div>
    </div>
    <div class="tabs-slider">
        <div class="splide" role="group" aria-label="Splide Basic HTML Example" id="classesSplide">
                    ...
                    <li class="splide__slide">
                        <div class="card-container">
                            ...
                            <div class="card-details">
                                <div class="card-header">Javascript for Beginners</div>
                                <div class="card-header-text">Global Code Institute</div>
                                <div class="card-instructor">Matthwe Davis</div>
                                <div class="card-rating">
                                    <div class="card-rating-value">4.5</div>
                                    <div class="card-rating-icons">
                                    ...
                                    <div class="card-rating-count-value">(301)</div>
                                </div>
                                <div class="card-start-date">
                                    Start Date -
                                    <div class="card-start-date-value">21 / 7 / 2024</div>
                                </div>
                                <div class="card-end-date">
                                    End Date -
                                    <div class="card-start-date-value">25 / 7 / 2024</div>
                                </div>
                                <div class="card-dead-line">
                                    Deadline -
                                    <div class="card-dead-line-value">30 / 7 / 2024</div>
                                </div>
                                <div class="card-fee">
                                    <div class="card-fee-value">250,000 MMK</div>
                                    <button class="card-enroll">Enroll</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-container">
    ...
    <div class="popular-instructors-section">
        <div class="popular-instructors-header">Popular Instructors</div>
        <div class="popular-instructors-text">These real-world experts are highly rated by learners like you.</div>
        <div class="splide" role="group" aria-label="Splide Basic HTML Example" id="instructorSplide">
            <div class="splide__track">
                <ul class="splide__list">
                    <li class="splide__slide">
                        <div class="instructor-card-container">
                            <div class="instructor-inner-wrapper">
                                <img src="../resources/img/instructor.png" alt="">
                                <div class="instructor-card-details">
                                    <div class="instructor-card-details-header">Matthwe Davis</div>
                                    <div class="instructor-card-details-text">Javascript,React,Nodejs
                                    </div>
                                    <div class="instructor-rating">
                                        <div class="instructor-rating-value">4.5</div>
                                        <ion-icon name="star" class="instructor-rating-icon"></ion-icon>
                                        <div class="instructor-rating-text">Instructor Rating</div>
                                    </div>
                                    <div class="instructor-student-count">
                                        <div class="instructor-student-count-value">12345</div>
                                        <div class="instructor-student-count-text">Students</div>
                                    </div>
                                    <div class="instructor-classes">
                                        <div class="instructor-classes-value">5</div>
                                        <div class="instructor-classes-text">Classes</div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="courses-search-section">
        <div class="courses-search-top-container">
            <div class="courses-search-header">All Web Development Courses</div>
            <input type="text" class="courses-search-search-box" placeholder="Search">
        </div>
        <div class="courses-search-filter-container">
            <div class="courses-search-filter-inner-wrapper">
                <div class="courses-search-filter-btn">
                    <ion-icon name="filter-outline"></ion-icon>
                    <div class="courses-search-filter-text">Filter</div>
                </div>
                <div class="courses-search-filter-sort-by-drop-down">
                    <div class="courses-search-filter-sort-by-drop-down-header">Sort by</div>
                    <label for="courses-search-filter-category"></label>
                    <select id="courses-search-filter-category">
                        <option value="most-popular">Most Popular</option>
                        <option value="new">New</option>
                        <option value="trending">Trending</option>
                    </select>
                </div>
                <div class="courses-search-filter-clear">Clear Filter</div>
            </div>
            <div class="courses-search-filter-results">
                <div class="courses-search-filter-results-value">
                    234
                </div>
                results
            </div>
    ...
    <div class="main-search-section">
        <div class="main-search-left-container">
            <div class="main-search-choose-rating choose-container">
                <div class="main-search-choose-rating-header choose-header">Rating</div>
                <div class="inner-wrapper">
                    <div class="main-search-choose-rating-four-half-up rating-box">
                        <input type="radio" name="ratingCheck" class="rating-check">
                        <div class="main-search-choose-rating-icons">
                            <ion-icon name="star"></ion-icon>
                            <ion-icon name="star"></ion-icon>
                            <ion-icon name="star"></ion-icon>
                            <ion-icon name="star"></ion-icon>
                        ...
                        <div class="main-search-choose-rating-four-half-up-text rating-text">4.5 & up</div>
                        <div class="main-search-choose-rating-count">(<span
                                class="main-search-choose-rating-count-four-half-up-value">452</span>)
                        </div>
                    </div>
                    <div class="main-search-choose-rating-four-up rating-box">
                        <input type="radio" name="ratingCheck" class="rating-check">
                        <div class="main-search-choose-rating-icons">
                            <ion-icon name="star"></ion-icon>
                            <ion-icon name="star"></ion-icon>
                        ...
                        <div class="main-search-choose-rating-four-up-text rating-text">4.0 & up</div>
                        <div class="main-search-choose-rating-count">(<span
                                class="main-search-choose-rating-count-four-up-value">452</span>)
                        </div>
                    </div>
                    <div class="main-search-choose-rating-three-half-up rating-box">
                        <input type="radio" name="ratingCheck" class="rating-check">
                        <div class="main-search-choose-rating-icons">
                            <ion-icon name="star"></ion-icon>
                            <ion-icon name="star"></ion-icon>
                        ...
                        <div class="main-search-choose-rating-three-half-up-text rating-text">3.5 & up</div>
                        <div class="main-search-choose-rating-count">(<span
                                class="main-search-choose-rating-count-three-half-up-value">452</span>)
                        </div>
                    </div>
                    <div class="main-search-choose-rating-three-up rating-box">
                        <input type="radio" name="ratingCheck" class="rating-check">
                        <div class="main-search-choose-rating-icons">
                            <ion-icon name="star"></ion-icon>
                            <ion-icon name="star"></ion-icon>
                        ...
                        <div class="main-search-choose-rating-three-up-text rating-text">3.0 & up</div>
                        <div class="main-search-choose-rating-count">(<span
                                class="main-search-choose-rating-count-three-up-value">452</span>)
                        </div>
                    </div>
                </div>
            </div>
            <div class="main-search-choose-institutes choose-container">
                <div class="main-search-choose-institutes-header choose-header">Institutes</div>
                <div class="inner-wrapper institute-wrapper" id="innerInstituteWrapper">
                    <div class="main-search-choose-institute-container institute-box">
                        <input type="checkbox" name="instituteCheck">
                        <div class="main-search-choose-institute-name">Tech Innovators Academy</div>
                    </div>
                    <div class="main-search-choose-institute-container institute-box">
                        <input type="checkbox" name="instituteCheck">
                        <div class="main-search-choose-institute-name">Global Code Institute</div>
                    </div>
                    <div class="main-search-choose-institute-container institute-box">
                        <input type="checkbox" name="instituteCheck">
                        <div class="main-search-choose-institute-name">NextGen Learning Hub</div>
                    </div>
                    <div class="main-search-choose-institute-container institute-box">
                        <input type="checkbox" name="instituteCheck">
                        <div class="main-search-choose-institute-name">Tech Innovators Academy</div>
                    ...
                    <div class="main-search-choose-institute-container institute-box">
                        <input type="checkbox" name="instituteCheck">
                        <div class="main-search-choose-institute-name">Tech Academy</div>
                    </div>
                </div>
                <button class="see-more" id="seeMoreInstituteButton">See more</button>
            </div>
            <div class="main-search-choose-available-classes choose-container">
                <div class="main-search-choose-institutes-header choose-header">All Available Classes</div>
                <div class="inner-wrapper available-classes-wrapper" id="innerClassWrapper">
                    <div class="main-search-choose-institute-container institute-box">
                        <input type="checkbox" name="instituteCheck">
                        <div class="main-search-choose-institute-name">Tech Innovators Academy</div>
                    </div>
