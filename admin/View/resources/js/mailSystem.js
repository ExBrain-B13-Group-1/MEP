                 ...
                 <div class="flex items-center mb-4">
                     ...
                     <div>
                        <div class="flex items-center">
                            ...
                            <div class="w-20"></div>
                             <div class="text-gray-500 text-sm">${email.time}</div>
                         </div>
                          <div class="text-gray-500 text-sm">${email.date}</div>
                     </div>
                    
                 </div>
                 <div class="email-content text-sm mb-4">
                     <p>Sender: ${email.senderMail}</p>
                     <p class="text-dark-blue">Subject: ${email.subject}</p>
                     </br>
                     <p>${email.content}</p>
                 </div>
                 <div class="reply-box flex space-x-2 mt-20">
                    <div>
                      <input type="text" class="w-full mb-2 p-2 border rounded bg-card-bg text-sm focus:outline-none focus:ring-1 focus:ring-blue-light-bg" placeholder="Subject">
                     <input type="text" class="w-full mb-2 p-2 border rounded bg-card-bg text-sm focus:outline-none focus:ring-1 focus:ring-blue-light-bg" placeholder="To" value="${email.senderMail}">
                     <button class="w-full bg-dark-blue text-white px-4 py-2 rounded text-sm">Send</button>
                     </div>
                     <textarea rows="6" class="w-full mb-2 p-2 border rounded bg-card-bg text-sm focus:outline-none focus:ring-1 focus:ring-blue-light-bg" placeholder="Comment"></textarea>
